...
if (isset($_POST['submit'])) {
    ...
    if (is_array($row) && !empty($row)) {
            ...
            if ($password === $row['mot_de_passe']) {
                ...
                switch ($_SESSION['type_de_compte']) {
                    ...
                    case 'manager':
                        ...
                        break;
                    case 'chef_dot':
                        header("Location: dothome.php");
                        break;
                    case 'agent_CM':
                        header("Location:Agent_cm/obj_dev/index.php");
                        break;
                    case 'agent_CH':
                        header("Location:Import_chiff_aff_internet_4G_re_n_1/index.php");
                        break;
                    case 'agent_RB':
        ...
        echo "<div class='message'><p>Email incorrect</p></div><br>";
        echo "<a href='index.php'><button class='btn'>Retour</button></a>";
    }
} else {
